 ...
 * Build: http://modernizr.com/download/#-boxshadow-textshadow-cssanimations-generatedcontent-cssgradients-csstransforms-csstransforms3d-csstransitions-touch-shiv-mq-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
...
(function() {
  ...
  this.Sync = {
    ...
    readyQueue: [],
    FAYE_HOST: "",
    PUSHER_API_KEY: "b6f51c0af0c7ee9c2d4a",
...
(function() {
  ...
  Sync.Token = (function(_super) {
    ...
    Token.prototype.afterUpdate = function() {
      var thisToken;
      console.log("it's working");
      this.$el.draggable({
        containment: ".tabletop"
      });
      thisToken = ".token" + this.$el.data("id");
      ...
      return $(thisToken).on("dblclick", function(){
      var tokenId = $(this).data("id");
