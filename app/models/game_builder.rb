class GameBuilder < ActiveRecord::Base
  ...
  def self.build_chess(g = nil)
    ...
    g.tokens.create(:name => "chess", :x_coordinate => 379, :y_coordinate => 10,  :image_0 => "chess/Chess_bdt60.png", :image_1 => "chess/Chess_bdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 156, :y_coordinate => 530, :image_0 => "chess/Chess_blt60.png", :image_1 => "chess/Chess_blt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 158, :y_coordinate => 8,   :image_0 => "chess/Chess_bdt60.png", :image_1 => "chess/Chess_bdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 381, :y_coordinate => 530, :image_0 => "chess/Chess_blt60.png", :image_1 => "chess/Chess_blt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 303, :y_coordinate => 6,   :image_0 => "chess/Chess_kdt60.png", :image_1 => "chess/Chess_kdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 307, :y_coordinate => 529, :image_0 => "chess/Chess_klt60.png", :image_1 => "chess/Chess_klt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 450, :y_coordinate => 10,  :image_0 => "chess/Chess_ndt60.png", :image_1 => "chess/Chess_ndt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 450, :y_coordinate => 531, :image_0 => "chess/Chess_nlt60.png", :image_1 => "chess/Chess_nlt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 80,  :y_coordinate => 6,   :image_0 => "chess/Chess_ndt60.png", :image_1 => "chess/Chess_ndt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 77,  :y_coordinate => 531, :image_0 => "chess/Chess_nlt60.png", :image_1 => "chess/Chess_nlt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 525, :y_coordinate => 79,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 525, :y_coordinate => 449, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 453, :y_coordinate => 77,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 451, :y_coordinate => 451, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 379, :y_coordinate => 77,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 375, :y_coordinate => 452, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 303, :y_coordinate => 81,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 304, :y_coordinate => 449, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 229, :y_coordinate => 80,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 230, :y_coordinate => 449, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 155, :y_coordinate => 77,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 154, :y_coordinate => 450, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 79,  :y_coordinate => 78,  :image_0 => "chess/Chess_pdt60.png", :image_1 => "chess/Chess_pdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 80,  :y_coordinate => 449, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    ...
    g.tokens.create(:name => "chess", :x_coordinate => 6,   :y_coordinate => 449, :image_0 => "chess/Chess_plt60.png", :image_1 => "chess/Chess_plt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 228, :y_coordinate => 7,   :image_0 => "chess/Chess_qdt60.png", :image_1 => "chess/Chess_qdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 231, :y_coordinate => 532, :image_0 => "chess/Chess_qlt60.png", :image_1 => "chess/Chess_qlt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 11,  :y_coordinate => 7,   :image_0 => "chess/Chess_rdt60.png", :image_1 => "chess/Chess_rdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 1,   :y_coordinate => 534, :image_0 => "chess/Chess_rlt60.png", :image_1 => "chess/Chess_rlt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 527, :y_coordinate => 9,   :image_0 => "chess/Chess_rdt60.png", :image_1 => "chess/Chess_rdt60.png", :flippable => false)
    g.tokens.create(:name => "chess", :x_coordinate => 522, :y_coordinate => 532, :image_0 => "chess/Chess_rlt60.png", :image_1 => "chess/Chess_rlt60.png", :flippable => false)
    g
  end
  ...
  def self.build_checkers(g = nil)
    ...
    g.tokens.create( :name => nil, :x_coordinate => 381, :y_coordinate => 12,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 232, :y_coordinate => 11,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 527, :y_coordinate => 10,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 380, :y_coordinate => 160, :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 157, :y_coordinate => 86,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 83,  :y_coordinate => 12,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 452, :y_coordinate => 88,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 306, :y_coordinate => 87,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 11,  :y_coordinate => 87,  :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 82,  :y_coordinate => 160, :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 529, :y_coordinate => 157, :image_0 => "checkers_red_0.png",  :image_1 => "checkers_red_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 454, :y_coordinate => 532, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 305, :y_coordinate => 534, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 306, :y_coordinate => 382, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 156, :y_coordinate => 382, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 380, :y_coordinate => 459, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 531, :y_coordinate => 460, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 230, :y_coordinate => 459, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 157, :y_coordinate => 532, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 10,  :y_coordinate => 532, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 81,  :y_coordinate => 458, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 453, :y_coordinate => 381, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
    g.tokens.create( :name => nil, :x_coordinate => 10,  :y_coordinate => 386, :image_0 => "checkers_grey_0.png", :image_1 => "checkers_grey_1.png", :flippable => true)
