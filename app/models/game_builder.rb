class GameBuilder < ActiveRecord::Base
  ...
  def self.build_chinese_checkers(g = nil)
    ...
    g.tokens.find_or_create_by(:name => "chinese_checkers1").update(:x_coordinate => 365, :y_coordinate => 90,  :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers2").update(:x_coordinate => 365, :y_coordinate => 150, :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers3").update(:x_coordinate => 310, :y_coordinate => 180, :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers4").update(:x_coordinate => 250, :y_coordinate => 215, :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers5").update(:x_coordinate => 255, :y_coordinate => 155, :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    ...
    g.tokens.find_or_create_by(:name => "chinese_checkers7").update(:x_coordinate => 425, :y_coordinate => 120, :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers8").update(:x_coordinate => 255, :y_coordinate => 90,  :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers9").update(:x_coordinate => 315, :y_coordinate => 55,  :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers10").update(:x_coordinate => 255, :y_coordinate => 25,  :image_0 => "cc_purple.png", :image_1 => "cc_purple.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers11").update(:x_coordinate => 530, :y_coordinate => 120, :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers12").update(:x_coordinate => 590, :y_coordinate => 160, :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers13").update(:x_coordinate => 640, :y_coordinate => 185, :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers14").update(:x_coordinate => 700, :y_coordinate => 220, :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers15").update(:x_coordinate => 700, :y_coordinate => 155, :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers16").update(:x_coordinate => 645, :y_coordinate => 125, :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers17").update(:x_coordinate => 585, :y_coordinate => 90,  :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers18").update(:x_coordinate => 700, :y_coordinate => 95,  :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers19").update(:x_coordinate => 645, :y_coordinate => 65,  :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
    g.tokens.find_or_create_by(:name => "chinese_checkers20").update(:x_coordinate => 700, :y_coordinate => 30,  :image_0 => "cc_blue.png",   :image_1 => "cc_blue.png", :flippable => false)
